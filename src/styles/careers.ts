...
export const careersVariants = tv({
  slots: {
    ...
    gridContainer: "flex flex-col lg:flex-row space-x-24 space-y-44 items-center justify-between",
    textContainer: "relative",
    sectionLabel: "text-lg/7 font-semibold text-dracula-main",
    title: "mt-4 lg:max-w-lg text-4xl font-semibold tracking-tight text-pretty text-dracula-dark",
    subtitleContainer: "mt-8 space-y-4 lg:max-w-lg text-lg/7 text-balance font-extralight text-dracula-dark",
