...
export const aboutVariants = tv({
  slots: {
    ...
    sectionLabel: 'text-lg/7 font-medium text-dracula-main',
    title: "mt-2 max-w-3xl text-4xl font-semibold tracking-tight text-pretty text-dracula-dark",
    subtitleContainer: "mt-8 space-y-4 max-w-3xl text-xl/8 text-balance font-extralight text-dracula-dark",
    missionContainer: "mt-20 grid grid-cols-1 lg:grid-cols-2 gap-24 lg:gap-8",
    missionText: "text-lg/7 lg:max-w-lg",
    missionTitle: "text-3xl font-semibold tracking-tight text-pretty text-dracula-dark",
    missionParagraphs: "mt-8 space-y-4 text-xl/8 text-balance font-extralight text-dracula-dark",
