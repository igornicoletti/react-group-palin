...
export const aboutVariants = tv({
  slots: {
    ...
    missionContainer: "mt-20 grid grid-cols-1 lg:grid-cols-2 gap-8",
    missionText: "max-w-lg",
    ...
    imageGrid: "lg:row-span-2 lg:-mr-16 xl:mr-auto -mx-8 grid grid-cols-2 gap-4 sm:-mx-16 sm:grid-cols-4 lg:mx-0 lg:grid-cols-2 lg:gap-4 xl:gap-8",
